  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Importe suas transações via CSV</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-xs text-blue-700 mt-2">
              <strong>Exemplo:</strong> 2024-01-15,Salário,5000,INCOME,Trabalho
            </p>
            <ul className="text-sm text-blue-800 mt-2 space-y-1">
              <li>- date: formato YYYY-MM-DD</li>
              <li>- type: EXPENSE ou INCOME</li>
              <li>- category: opcional (será criada automaticamente)</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-green-600">
                <CheckCircle />
                <span className="font-semibold">{result.imported} transações importadas</span>
              </div>
              {result.errors > 0 && (
            ...
            {result.imported > 0 && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-800">
                  As transações foram importadas com sucesso. Acesse a página de Finanças para visualizá-las.
                </p>
              </div>
            )}
          </div>
